...
_PROFILE_CONFIG = devpipeline_core.config.profile.read_profiles(
    devpipeline_core.config.paths.get_profile_path(_CONFIG_DIR))
...
class TestConfigProfile(unittest.TestCase):
    ...
    def test_single(self):
        ...
        count = devpipeline_core.config.profile.apply_all_profiles(
